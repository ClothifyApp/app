...
import { InfoWrapper, Heading, Body } from './styles';

export default function Info({ isOpen = true }) {
  return (
      ...
      <div className='open-info'>
        <Heading>
          ...
          <div className='name-gender'>
            <h3>
              User actual name <FontAwesomeIcon icon={faCheckCircle} />
            </h3>
            <p>
              <FontAwesomeIcon icon={faVenusMars} /> Female
            </p>
          </div>
        </Heading>
        <Body>
